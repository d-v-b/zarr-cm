...
from . import cs, multiscales, proj, spatial, stac, uom
...
ConventionName = Literal[
    "proj", "spatial", "multiscales", "license", "uom", "stac", "cs", "geo-proj"
]
...
CanonicalConventionName = Literal[
    "proj", "spatial", "multiscales", "license", "uom", "stac", "cs"
]
...
_REGISTRY: Final[dict[CanonicalConventionName, _ConventionModule]] = {
    ...
    "cs": _ConventionModule(
        cs.UUID,
        cs.CMO,
        cs.CONVENTION_KEYS,
        cs.REVISION_BY_SCHEMA_URL,
        cs.validate,
        cs.insert,
        cs.extract,
        cs.detect,
